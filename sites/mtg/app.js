...
var _m_renaud$mtg_counter$Types$SelectTab = function (a) {
...
var _m_renaud$mtg_counter$State$init = function () {
	var model = {
	...
	return A4(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_debois$elm_mdl$Material_Layout$onSelectTab(_m_renaud$mtg_counter$Types$SelectTab)
			]),
		{
